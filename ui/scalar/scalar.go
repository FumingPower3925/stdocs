...
//
// The CDN URL is pinned to a specific version (1.65.0) and points at
...
const scalarSRIHash = "sha384-gt+HUL6cdHY8e/42QabdnRnTnPIwpNGVKHZsmJoezGnYBXcsfP7GrSfbo2UVcxm3"
