...
// connection.
//
// The vendored bundle is pinned to @scalar/api-reference@1.62.6 and
...
//go:generate bash -c "curl -fsSL https://cdn.jsdelivr.net/npm/@scalar/api-reference@1.62.6/dist/browser/standalone.js -o assets/standalone.js"
